...
function waitForSpicetify() {
    ...
    async function loadCustomCSS() {
        ...
        try {
            ...
            const randomTimestamp = new Date().getTime();  // Generate a unique timestamp
            const link = document.createElement('link');
            link.rel = 'stylesheet';
            link.href = `https://cdn.jsdelivr.net/gh/${repoOwner}/${repoName}@${latestCommitHash}/assets/css/bloomTweaksLegacy.css?ts=${randomTimestamp}`; // Cache busting
    ...
    // Function to move the element to a new parent
    function moveExternalExtensionButtons() {
        ...
        if (button && newParent) {
            ...
            console.log('Button successfully moved.');
        } else {
